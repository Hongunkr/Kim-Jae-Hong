...
.select input class="form-control"[type=password]{
   width: 420px;
   height: 35px;
} 
...
<form action="./myprofile" method="post">
   ...
   <div class="select">
      ...
      <input class="form-control" type="text" id="userNick" name="userNick" value="${detail.userNick}" required>
      <span id="userNick_msg" class="msg"></span>
   </div>

   <div class="select">
      <label for="email">이메일</label>
      <input class="form-control" type="text" id="email" name="email" value="${detail.email}" required>
